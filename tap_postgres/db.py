...
def open_connection(conn_config, logical_replication=False):
    ...
    try:
        ...
        if f'could not translate host name "{conn_config["host"]}" to address' in message or 'Is the server running on that host and accepting TCP/IP connections?' in message:
